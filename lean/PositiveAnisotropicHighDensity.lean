...
import PositiveSamplingOriginalCells
...
namespace KakeyaFormal.PositiveAnisotropicHighDensity
...
theorem original_parameters {k : ℕ} {m d d' pExp qExp : ℝ}
  ...
  obtain ⟨δs,hδs,hδs1,cS,hcS,hmain⟩ := PositiveSamplingOriginalCells.construct hbase hlift hm hpExp hd hqExp hD
...
end KakeyaFormal.PositiveAnisotropicHighDensity
