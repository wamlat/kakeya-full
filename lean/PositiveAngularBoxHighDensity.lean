...
import PositiveAnisotropicHighDensity
...
namespace KakeyaFormal.PositiveAngularBoxHighDensity
...
theorem construct {k : ℕ} {m d d' pExp qExp : ℝ}
    ...
    (hm : 0 ≤ m) (hp : 0 < pExp) (hd : 0 ≤ d) (hqExp : 2 ≤ qExp)
  ...
  obtain ⟨δs,hδs,hδs1,cS,hcS,hmain⟩ := PositiveAnisotropicHighDensity.original_log_parameters hbase hlift hm hp hd hqExp hD
...
end KakeyaFormal.PositiveAngularBoxHighDensity
