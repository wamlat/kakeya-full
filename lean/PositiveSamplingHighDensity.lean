import PositiveSamplingMeasurablePivot
...
namespace KakeyaFormal.PositiveSamplingHighDensity
...
theorem construct {k : ℕ} {m d d' pExp qExp : ℝ}
  ...
  obtain ⟨δ₀,hδ₀,hδ₀1,cP,hcP,hcases⟩ := PositiveSamplingMeasurablePivot.low_or_pivot
...
end KakeyaFormal.PositiveSamplingHighDensity
