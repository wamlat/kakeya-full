...
namespace KakeyaFormal.PositiveAllAngleSeparation
...
theorem all_scales {k : ℕ} {m d d' pExp qExp : ℝ}
  ...
  obtain ⟨c,hc,hmain⟩ := PositiveAllAnglePivot.all_scales hbase hlift hm hmn hp hd hq hD
...
end KakeyaFormal.PositiveAllAngleSeparation
