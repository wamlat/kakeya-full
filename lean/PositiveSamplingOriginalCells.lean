import PositiveSamplingHighDensity
...
namespace KakeyaFormal.PositiveSamplingOriginalCells
...
theorem construct {k : ℕ} {m d d' pExp qExp : ℝ}
  ...
  obtain ⟨δ₀,hδ₀,hδ₀1,c,hc,hmain⟩ := PositiveSamplingHighDensity.all_exponents hbase hlift hm hpExp hd hqExp hD
...
end KakeyaFormal.PositiveSamplingOriginalCells
