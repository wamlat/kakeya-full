...
import PositiveSampledMarkedEstimate
...
namespace KakeyaFormal.PositiveSamplingMeasurablePivot
...
theorem low_or_pivot {k : ℕ} {m d d' pExp qExp : ℝ}
  ...
  obtain ⟨c,hc,hcore⟩ := PositiveSampledMarkedEstimate.construct hbase hlift hm hpExp hd hqExp
...
end KakeyaFormal.PositiveSamplingMeasurablePivot
