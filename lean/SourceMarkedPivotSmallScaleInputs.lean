...
inputs (5.4) and (5.5), assumed only at eccentricity at least two. The original marked configuration still uses the
...
-/
namespace KakeyaFormal.SourceMarkedPivotSmallScaleInputs
...
end KakeyaFormal.SourceMarkedPivotSmallScaleInputs
