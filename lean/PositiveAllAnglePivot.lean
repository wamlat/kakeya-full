import PositiveAngularBoxAllCases
...
namespace KakeyaFormal.PositiveAllAnglePivot
...
theorem logarithmic_range {k : ℕ} {m d d' pExp qExp : ℝ}
  ...
  have hC : 0 ≤ KakeyaScalar.pivotDensity pExp qExp := by
    ...
    linarith
  obtain ⟨cP,hcP,hpiece⟩ := PositiveAngularBoxAllCases.construct hbase hlift hm hmn hp hd hq
...
end KakeyaFormal.PositiveAllAnglePivot
